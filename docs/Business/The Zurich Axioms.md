...
<aside>
💡 After reading first chapter i want to explain this in simple terms, Zurich axioms are rules for risk taking. there’s 12 major rules and 16 minor rules
...
<aside>
💡 Auther mostly want you take risk even if you’re always worried about your investment all time. this should be default state. He also stated to learn to enjoy being worried all time
...
<aside>
💡 First part of this chapter just explain that, no one knows or predict what’s going to happen. Ignore everyone who says so. Most people who is famous for all predictions makes lots of them and someone of them turns out to be right. But publicity only mentions one who turns out to be right while avoiding everything else.
...
<aside>
🚫 examples explain in this part is pretty bad so i am bit hesitant to accept this axiom.
